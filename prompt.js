...
- bins_below = round(35 + (volatility/5)*34) clamped to [35,69]. bins_above = 0 for bid_ask unless the active strategy explicitly requires a different positive value.

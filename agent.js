...
const MANAGER_TOOLS  = new Set(["close_position", "partial_close_position", "claim_fees", "swap_token", "update_config", "get_position_pnl", "get_my_positions", "get_wallet_positions", "set_position_note", "add_pool_note", "get_wallet_balance"]);
...
const INTENT_TOOLS = {
  ...
  close:       new Set(["close_position", "partial_close_position", "get_my_positions", "get_position_pnl", "get_wallet_balance", "swap_token"]),
